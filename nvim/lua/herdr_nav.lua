-- vim-herdr-navigation — Neovim side (github.com/paulbkim-dev/vim-herdr-navigation)
-- Ctrl+h/j/k/l crosses Neovim splits, then herdr panes at a split edge. Falls
-- back to vim-tmux-navigator when running inside plain tmux instead of herdr.
